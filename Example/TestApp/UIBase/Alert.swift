...
class AlertResult: CustomStringConvertible {
	var action: String = ""
	var textArray = [String]()
...
class Alert {
	var superPage: UIViewController
	var actionItems = [(text: String, type: UIAlertAction.Style)]()
	var style: UIAlertController.Style = .alert

	var title: String? = nil
	var message: String? = nil
	//hint -> text
	var textFiels = [(hint: String, text: String)]()

	init(_ superPage: UIViewController) {
